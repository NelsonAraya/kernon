  				...
  				<form class="form-horizontal" method="POST" action="{{ route('registro.store') }}">
  					...
  					<div class="form-group row">
  						<div class="col-md-2">
  							...
  							<input type="text" id="run" name="run" class="form-control" autocomplete="off">
  						</div>
  						<div class="col-md-4">
  						...
  						<div class="col-md-3">
  							...
  							<input type="text" id="paterno" name="apellidop" class="form-control" autocomplete="off">
  						</div>
  						<div class="col-md-3">
  							<label for="materno">Materno</label>
  							<input type="text" id="materno" name="apellidom" class="form-control" autocomplete="off">
  						</div>
  					</div>
  					<div class="form-group row">
  						<div class="col-md-2">
